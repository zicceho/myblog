...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '小宇宙', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '你的互联网领航员', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://na.885111.xyz', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, 导航', // 网站关键词 英文逗号隔开
...
FONT_STYLE: process.env.NEXT_PUBLIC_FONT_STYLE || 'font-sans font-bold', // ['font-serif','font-sans'] 两种可选，分别是衬线和无衬线: 参考 https://www.jianshu.com/p/55e410bd2115
...
// END ************网站字体*****************
  ...
  POST_URL_PREFIX: process.env.NEXT_PUBLIC_POST_URL_PREFIX || 'art',
  ...
  MUSIC_PLAYER_METING_ID:
    process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '2312165875', // 对应歌单的 id
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '小宇宙', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
    process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '你的互联网领航员', // 站点描述，被notion中的页面描述覆盖
