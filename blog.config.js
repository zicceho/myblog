...
FONT_STYLE: process.env.NEXT_PUBLIC_FONT_STYLE || 'font-serif', // 字体是否有衬线：font-sans，font-serif

FONT_URL: [
  'https://npm.elemecdn.com/lxgw-wenkai-webfont@1.6.0/style.css', // 字体CSS
  // 在这里添加其他字体的 URL，如果需要的话
],
